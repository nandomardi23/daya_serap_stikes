                        ...
                        <div>
                            ...
                            <div className="relative">
                                <TextInput
                                    ...
                                    name="password"
                                    value={data.password}
                                    className="mt-1 block w-full px-5 py-3.5 pr-12 rounded-xl border-slate-200 bg-slate-50 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all text-slate-800 font-medium text-sm tracking-widest"
                                ...
                                <button
                                    ...
                                    className="absolute inset-y-0 right-0 flex items-center pr-4 mt-1 text-slate-400 hover:text-slate-600 transition-colors"
                                    tabIndex={-1}
                                >
                                    {showPassword ? (
